...
public interface ServicioComLogistica extends com.zeroc.Ice.Object
{
    ...
    java.util.List<java.lang.String> consultarAlarmasPendientes(int codigoOperador, com.zeroc.Ice.Current current);
    ...
    **/
     ...
     * @return -
    **/
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutputStream> _iceD_consultarAlarmasPendientes(ServicioComLogistica obj, final com.zeroc.IceInternal.Incoming inS, com.zeroc.Ice.Current current)
    {
        com.zeroc.Ice.Object._iceCheckMode(null, current.mode);
        com.zeroc.Ice.InputStream istr = inS.startReadParams();
        int iceP_codigoOperador;
        iceP_codigoOperador = istr.readInt();
        inS.endReadParams();
        java.util.List<java.lang.String> ret = obj.consultarAlarmasPendientes(iceP_codigoOperador, current);
        com.zeroc.Ice.OutputStream ostr = inS.startWriteParams();
        StringSeqHelper.write(ostr, ret);
        inS.endWriteParams(ostr);
        return inS.setResult(ostr);
    ...
    **/
        ...
        throws com.zeroc.Ice.UserException
    {
        ...
        switch(pos)
        {
            ...
            case 2:
            {
                return _iceD_consultarAlarmasPendientes(this, in, current);
            }
            case 3:
            {
