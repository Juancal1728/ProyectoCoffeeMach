...
public interface ServicioAbastecimiento extends com.zeroc.Ice.Object
{
    ...
    boolean abastecerRecurso(int codMaquina, RecursoAbastecimiento recurso, int cantidad, int idAlarma, com.zeroc.Ice.Current current);
    ...
    **/
     ...
     * @return -
    **/
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutputStream> _iceD_abastecerRecurso(ServicioAbastecimiento obj, final com.zeroc.IceInternal.Incoming inS, com.zeroc.Ice.Current current)
    {
        com.zeroc.Ice.Object._iceCheckMode(null, current.mode);
        com.zeroc.Ice.InputStream istr = inS.startReadParams();
        int iceP_codMaquina;
        ...
        inS.endReadParams();
        boolean ret = obj.abastecerRecurso(iceP_codMaquina, iceP_recurso, iceP_cantidad, iceP_idAlarma, current);
        ...
        throws com.zeroc.Ice.UserException
    {
        ...
        switch(pos)
        {
            ...
            case 1:
            {
                return _iceD_abastecerRecurso(this, in, current);
            }
            case 2:
            {
