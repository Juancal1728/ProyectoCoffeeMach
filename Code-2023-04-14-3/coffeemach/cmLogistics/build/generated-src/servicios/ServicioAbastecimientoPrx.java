...
public interface ServicioAbastecimientoPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    default boolean abastecerRecurso(int codMaquina, RecursoAbastecimiento recurso, int cantidad, int idAlarma)
    {
        return abastecerRecurso(codMaquina, recurso, cantidad, idAlarma, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default boolean abastecerRecurso(int codMaquina, RecursoAbastecimiento recurso, int cantidad, int idAlarma, java.util.Map<String, String> context)
    {
        return _iceI_abastecerRecursoAsync(codMaquina, recurso, cantidad, idAlarma, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<java.lang.Boolean> abastecerRecursoAsync(int codMaquina, RecursoAbastecimiento recurso, int cantidad, int idAlarma)
    {
        return _iceI_abastecerRecursoAsync(codMaquina, recurso, cantidad, idAlarma, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.Boolean> abastecerRecursoAsync(int codMaquina, RecursoAbastecimiento recurso, int cantidad, int idAlarma, java.util.Map<String, String> context)
    {
        return _iceI_abastecerRecursoAsync(codMaquina, recurso, cantidad, idAlarma, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.Boolean> _iceI_abastecerRecursoAsync(int iceP_codMaquina, RecursoAbastecimiento iceP_recurso, int iceP_cantidad, int iceP_idAlarma, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.Boolean> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "abastecerRecurso", null, sync, null);
