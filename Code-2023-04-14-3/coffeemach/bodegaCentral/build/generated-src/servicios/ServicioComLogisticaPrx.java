...
public interface ServicioComLogisticaPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    default java.util.List<java.lang.String> consultarAlarmasPendientes(int codigoOperador)
    {
        return consultarAlarmasPendientes(codigoOperador, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default java.util.List<java.lang.String> consultarAlarmasPendientes(int codigoOperador, java.util.Map<String, String> context)
    {
        return _iceI_consultarAlarmasPendientesAsync(codigoOperador, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<java.util.List<java.lang.String>> consultarAlarmasPendientesAsync(int codigoOperador)
    {
        return _iceI_consultarAlarmasPendientesAsync(codigoOperador, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.util.List<java.lang.String>> consultarAlarmasPendientesAsync(int codigoOperador, java.util.Map<String, String> context)
    {
        return _iceI_consultarAlarmasPendientesAsync(codigoOperador, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.util.List<java.lang.String>> _iceI_consultarAlarmasPendientesAsync(int iceP_codigoOperador, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.util.List<java.lang.String>> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "consultarAlarmasPendientes", null, sync, null);
        f.invoke(true, context, null, ostr -> {
                     ostr.writeInt(iceP_codigoOperador);
                 }, istr -> {
                     java.util.List<java.lang.String> ret;
