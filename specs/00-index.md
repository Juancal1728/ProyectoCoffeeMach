...
- **Specs 15-16**: Arquitectura de despliegue, diagramas y guia de sustentacion.
...
| [06](06-abastecimiento-remoto.md) | Abastecimiento remoto de la maquina | `ServidorCentral` -> `coffeeMach/ServicioAbastecimiento` | Implementado |
| [07](07-servicio-logistica.md) | Servicio de logistica para operadores | `ServidorCentral/comunicacion/ControlComLogistica` | Implementado |
...
| [10](10-cmlogistics-client.md) | Cliente cmLogistics completo (GUI Swing + paquetes patron) | `cmLogistics/logistica/LogisticaController` + `controlAlarma/*` + `tecnicoMantenimiento/*` + `zonaGeografica/*` | Implementado |
...
| [12](12-definir-producto-y-fixes.md) | definirProducto + correcciones ServidorCentral + ManejadorDatos | `ServidorCentral/receta/ProductoReceta` + `ServidorCentral/modelo/ManejadorDatos` | Implementado |
| [13](13-plan-maestro-cobertura.md) | Cobertura del Plan Maestro (verificacion) | Todos los modulos | Implementado |
| [14](14-build-e-integracion.md) | Build, config y pruebas de integracion | Todos los modulos | Implementado (pendiente prueba end-to-end) |
| [15](15-diagrama-deployment-crc.md) | Diagrama de deployment — tarjetas CRC y patrones | Arquitectura distribuida completa | Referencia |
| [16](16-informe-despliegue.md) | Informe unificado de despliegue y ejecucion | Todos los modulos | Referencia |
